...
React does not track changes to regular variables. So so that causes the page to not 
update when the button is clicked. Using useState() lets React track the message and 
re-render the component when it chnages.
